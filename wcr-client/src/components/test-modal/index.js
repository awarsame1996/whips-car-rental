...
export const TestModal = ({ car, id }) => {
  ...
  const onSubmit = async (formData) => {
    const { isDailyCheckBox, isWeeklyCheckBox, startDate, endDate } = formData;
    let isDaily = false;
    let isWeekly = false;
    if (isDailyCheckBox) {
      isDaily = true;
            ...
            <div className="row">
              ...
              >
                <div className="card-body text-white">
                  <h5 className="card-title">{car.specifications.similar}</h5>
                </div>
              </div>
              <form
                ...
                <div className="payment-options">
                  ...
                  <div className="border-sm-start-none border-bottom mt-3">
                    <div className="form-floating mb-3">
                      ...
                      />
                      {errors?.startDate && <p>Please input a start date</p>}
