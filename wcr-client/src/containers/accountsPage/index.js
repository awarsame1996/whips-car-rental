    ...
    <div className="d-flex row justify-content-center mb-5">
      ...
      >
        ...
        <div class="row mt-3">
          ...
          >
            <div class="card mt-5 ">
              <div class="card-body text-center">
                ...
                />
                <h5 class="my-3">Abdinasir Warsame</h5>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <h3 class="mb-4 text-uppercase text-center">My Profile</h3>

            <div class="row">
              <div class="col-md-6 ">
                <div class="form-outline">
                  <label class="form-label m-2" for="form3Example1m">
                    First Name
                  </label>
                  <input
                    type="text"
                    id="form3Example1m"
                    class=" form-control-lg mt-1 mb-2"
              ...
              <div class="col-md-6 ">
                <div class="form-outline">
                  ...
                  <input
                    ...
                    id="form3Example1m"
                    class=" form-control-lg mt-1 mb-2"
                    placeholder="Abdinasir_jirde@hotmail.com"
                  />
                </div>
                <hr />
              </div>
          ...
          <div class="d-flex justify-content-center pt-3 mb-4 mt-5">
            <button
              style={{
                Height: '15rem',
                width: '25rem',
